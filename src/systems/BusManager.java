...
public class BusManager { // this class handles all tasks related to busses

    public final static ArrayList<Bus> BusList = new ArrayList<>(); // this is the bus list
    ...
    public static Bus addBus() {
        ...
        while (!isSet_cap) {
            ...
            if (newCapacity <= 0 || newCapacity > 150) {
        ...
        while (!isSet_price) {
            ...
            int truncated = (int) (newPrice * 100); // truncate to two decimals
            newPrice =  (float) truncated / 100;
