...
// this class is used to inject a number of busses into the program when its started
public class BusInjector {
    ...
    private static LocalDate[] setBus_date() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            OptionalInt monthOl = random.ints(3,4).findFirst();
    ...
    public static void injectBus() { // inject busses
